...
void Texture::createTextureImageView() {
  VkImageViewType imgtype= getImageViewType();
  imageView = createImageView(device, image, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_ASPECT_COLOR_BIT, getImageViewType(), getLayerCount());
}
